...
// Functions to verify the single/multiplayer status of a game
	...
	virtual BOOL IsDestroy( void ) { return FALSE; };
	virtual BOOL IsHeadQuarters( void ) { return FALSE; };
	virtual const char *GetGameDescription( void ) { return "Counter-Strike DM"; }  // this is the game name that gets seen in the server browser
