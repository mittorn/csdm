...
public:
	...
	static CGrenade *ShootTimed2( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time, char *iModel, int iDamage );
	static CGrenade *FlashShoot( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time, char *iModel, int iDamage );
	static CGrenade *SmokeShoot( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time, char *iModel, int iDamage );
...
#define WEAPON_FLASHBANG		5
#define WEAPON_SMOKEGRENADE		6
#define WEAPON_M4A1				7
#define WEAPON_AK47				8
#define WEAPON_AWP				9
#define WEAPON_GALIL			10
#define WEAPON_FAMAS			11
#define WEAPON_DEAGLE			12
#define WEAPON_AUG				13
#define WEAPON_SG552			14
...
public:
	...
	int			iSlot( void )		{ return ItemInfoArray[ m_iId ].iSlot + 1; }
};
...
public:
	...
	void DefaultFire( CBasePlayer *m_pPlayer, int cShots, wepspread_t spread, float damage, int anim, char *sound, int genevent, int RadOfBright );
	struct wepspread_t wepspread_s;

	//void FireRemaining( int &iShotsFired, float &flShootTime, BOOL bIsGlock );
...
public:
	...
	virtual void Attack( int iDamage, float NextPrimary, float NextSecondary, float iDistance, int iAnim );
...
public:
	virtual void Spawn( void );
	virtual void Precache( void );
	virtual int iItemSlot( void ) { return 1; }
	virtual int GetItemInfo(ItemInfo *p);
	virtual int AddToPlayer( CBasePlayer *pPlayer );
	virtual void PrimaryAttack( void );
	virtual void BrustAttack( void );
	virtual void SecondaryAttack( void );
	virtual BOOL Deploy( void );
	virtual void Reload( void );
	virtual void WeaponIdle( void );
