...
//	virtual void	SetActivator( CBaseEntity *pActivator ) {}
	...
	Vector		FireBulletsPlayer( ULONG	cShots, Vector  vecSrc, Vector	vecDirShooting,	Vector	vecSpread, float flDistance, int iBulletType, int iTracerFreq, int iDamage, entvars_t *pevAttacker, int shared_rand );
	Vector		FireBulletsPlayer2( ULONG cShots, Vector vecSrc, Vector vecEnd, int iTracerFreq, int iDamage, entvars_t *pevAttacker, int shared_rand );
	void		FireBulletsWater( Vector vecSrc, Vector vecEnd, float ScaleSplash1, float ScaleSplash2 );
