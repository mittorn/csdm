...
int CHudAmmo::Draw(float flTime)
{
	...
	if (m_pWeapon->iAmmoType > 0)
	{
		...
		if (pw->iClip >= 0)
		{
			...
			x = gHUD.DrawHudNumber2( x, y, false, 3, pw->iClip, r, g, b);
			...
			x = gHUD.DrawHudNumber2( x, y, false, 3, gWR.CountAmmo( pw->iAmmoType ), r, g, b);
	...
	// TANKIST: CrossHair
	if( m_pWeapon->iId == 0 || m_pWeapon->iId == 9 )
		return 1;
	...
	int iHeight = 10;
    int iWidth = 1;
	float cross_size = gHUD.NormalSize;

	gHUD.RealSize += speed / 16;
	if( InJump )
		gHUD.RealSize += 10;
	if( CL_ButtonBits( 0 ) & IN_DUCK )
		gHUD.RealSize -= 10;
    ...
    y = ScreenHeight / 2;
    FillRGBA(x - iHeight, y, iHeight, iWidth, r, g, b, a);
    ...
    x = ScreenWidth / 2;
    y = ScreenHeight / 2 - cross_size + 1;
    FillRGBA(x, y - iHeight, iWidth, iHeight, r, g, b, a);
