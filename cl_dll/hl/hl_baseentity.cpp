...
CGrenade * CGrenade:: ShootTimed2( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time, char *iModel, int iDamage ){ return 0; }
CGrenade * CGrenade:: FlashShoot( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time, char *iModel, int iDamage ){ return 0; }
CGrenade * CGrenade:: SmokeShoot( entvars_t *pevOwner, Vector vecStart, Vector vecVelocity, float time, char *iModel, int iDamage ){ return 0; }
