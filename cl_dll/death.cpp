...
{
	if( g_PlayerExtraInfo[clientIndex].teamnumber == 1 )
		return g_ColorRed;
	else if( g_PlayerExtraInfo[clientIndex].teamnumber == 2 )
		return g_ColorBlue;
	else return g_ColorGrey;
}
...
int CHudDeathNotice :: MsgFunc_DeathMsg( const char *pszName, int iSize, void *pbuf )
{
	...
	if( headshot ) rgDeathNoticeList[i].Headshot = true;
